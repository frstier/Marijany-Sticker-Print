...
var BrowserPrint = function () {
    ...
    } var f = {}, p = {}, q = /^((?!chrome|android).)*safari/i.test(navigator.userAgent); navigator.userAgent.indexOf("Trident/7.0"); var dIp = "127.0.0.1"; try { var st = localStorage.getItem("zebra_agent_ip"); if (st) dIp = st; } catch (e) { } var m = "http://" + dIp + ":9100/"; if ("https:" === location.protocol) m = "https://" + dIp + ":9101/"; f.Device = function (a) {
